...
#        self.image_display.setPixmap(QtGui.QPixmap.fromImage(image))
    ...
    def _display_output_image(self, img_addr, bbox):
    ...
    def _create_central_widget(self):
        ...
        #self.output_scroll.setWidget(self.output_scroll)
        ...
        layout_01.addWidget(self.input_image_display)
        # Black Place-holder to display output image
        self.output_image_display = QLabel('Output')
        layout_01.addWidget(self.output_image_display)
